...
public class NettyClient {
	...
	/**
	 * 这里要实现超时重连机制 还有搞懂三次握手的SO_BACKLOG 的原理 ChannelFutureListener
	 */
	public void beginConnect() {
		...
		bootstrap.group(this.worke).channel(NioSocketChannel.class).option(ChannelOption.SO_KEEPALIVE, true).remoteAddress(this.host, this.port)
